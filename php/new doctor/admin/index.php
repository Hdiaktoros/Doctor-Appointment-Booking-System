...
<head>
    ...
    <title>Xpert Health - Admin/Doctor login</title>
...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal">Xpert Health Admin/Doctor login</h1>
            <span id="error"></span>
            ...
            <div class="form-group">
             ...
             <div class="form-group text-center">
                 <p>Contact us to register your hospital or doctors<a href="mailto:Admin@xperthealth.com"><br>Mail</a></p>
             </div>
        </form>
    </main>
